...
CREATE TABLE `role`  (
  ...
  `role_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '角色标题',
...
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES (1, 'root', '管理员', '管理系统中的所有权限', '2019-05-28 09:37:00', '2020-04-30 11:31:01', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户信息表' ROW_FORMAT = Dynamic;
